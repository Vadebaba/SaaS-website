...
const TestimonialsColumn = (props: {
  ...
  <div className={props.className}>
    <motion.div
      ...
      className='className="flex flex-col mt-10 gap-6 pb-6'
    >
      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-desc mt-5" >
            From  intuitive design to powerful features, our app has become Adopting
            an essential tool for users around the world.
          </p>
        </div>

        <div className='flex justify-center gap-6 mt-10 max-h-[720px] overflow-hidden
